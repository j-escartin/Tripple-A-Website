...
import com.product.service.exception.NoSuchCustomerException;
import com.product.service.model.Customer;
import com.product.service.model.CustomerTable;
import com.product.service.model.impl.CustomerImpl;
import com.product.service.model.impl.CustomerModelImpl;
import com.product.service.service.persistence.CustomerPersistence;
import com.product.service.service.persistence.CustomerUtil;
...
public class CustomerPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByGroupFinder;
	private FinderPath _finderPathWithoutPaginationFindByGroupFinder;
	private FinderPath _finderPathCountByGroupFinder;
	 ...
	 */
	@Override
	public List<Customer> findByGroupFinder(long groupId) {
		return findByGroupFinder(
	 ...
	 */
	@Override
	public List<Customer> findByGroupFinder(long groupId, int start, int end) {
		return findByGroupFinder(groupId, start, end, null);
	}
	 ...
	 */
	@Override
	public List<Customer> findByGroupFinder(
		long groupId, int start, int end,
		OrderByComparator<Customer> orderByComparator) {

		return findByGroupFinder(groupId, start, end, orderByComparator, true);
	}
	...
	public List<Customer> findByGroupFinder(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByGroupFinder;
				finderArgs = new Object[] {groupId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByGroupFinder;
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_GROUPFINDER_GROUPID_2);
	 ...
	 */
	@Override
	public Customer findByGroupFinder_First(
			long groupId, OrderByComparator<Customer> orderByComparator)
		throws NoSuchCustomerException {

		Customer customer = fetchByGroupFinder_First(
	 ...
	 */
	@Override
	public Customer fetchByGroupFinder_First(
		long groupId, OrderByComparator<Customer> orderByComparator) {

		List<Customer> list = findByGroupFinder(
	 ...
	 */
	@Override
	public Customer findByGroupFinder_Last(
			long groupId, OrderByComparator<Customer> orderByComparator)
		throws NoSuchCustomerException {

		Customer customer = fetchByGroupFinder_Last(groupId, orderByComparator);
	 ...
	 */
	@Override
	public Customer fetchByGroupFinder_Last(
		long groupId, OrderByComparator<Customer> orderByComparator) {

		int count = countByGroupFinder(groupId);
	 ...
	 */
	@Override
	public Customer[] findByGroupFinder_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupFinder_PrevAndNext(
				session, customer, groupId, orderByComparator, true);

			array[1] = customer;

			array[2] = getByGroupFinder_PrevAndNext(
	...
	protected Customer getByGroupFinder_PrevAndNext(
	 ...
	 */
	@Override
	public void removeByGroupFinder(long groupId) {
		for (Customer customer :
				findByGroupFinder(
					groupId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
	 ...
	 */
	@Override
	public int countByGroupFinder(long groupId) {
		FinderPath finderPath = _finderPathCountByGroupFinder;
	...
	private static final String _FINDER_COLUMN_GROUPFINDER_GROUPID_2 =
		"customer.groupId = ?";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByGroupFinder = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByGroupFinder",
			new String[] {
		...
		_finderPathWithoutPaginationFindByGroupFinder = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByGroupFinder",
			new String[] {Long.class.getName()}, new String[] {"groupId"},
			true);

		_finderPathCountByGroupFinder = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByGroupFinder",
			new String[] {Long.class.getName()}, new String[] {"groupId"},
			false);
