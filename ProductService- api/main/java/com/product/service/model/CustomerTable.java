...
/**
 * The table class for the &quot;SP_Customer&quot; database table.
 *
...
public class CustomerTable extends BaseTable<CustomerTable> {
	...
	public final Column<CustomerTable, String> customerValidId = createColumn(
		"customerValidId", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
	public final Column<CustomerTable, String> customerConNo = createColumn(
		"customerConNo", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
	public final Column<CustomerTable, Long> productsId = createColumn(
		"productsId", Long.class, Types.BIGINT, Column.FLAG_DEFAULT);
	...
	private CustomerTable() {
		super("SP_Customer", CustomerTable::new);
	}
