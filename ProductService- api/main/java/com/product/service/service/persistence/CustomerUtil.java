...
public class CustomerUtil {
	...
	public static Customer findByUuid_First(
		...
		throws com.product.service.exception.NoSuchCustomerException {
	 ...
	 * @return the matching customers
	 */
	public static List<Customer> findByGroupFinder(long groupId) {
		return getPersistence().findByGroupFinder(groupId);
	}
	 ...
	 * @return the range of matching customers
	 */
	public static List<Customer> findByGroupFinder(
		long groupId, int start, int end) {

		return getPersistence().findByGroupFinder(groupId, start, end);
	}
	...
	public static List<Customer> findByGroupFinder(
		...
		return getPersistence().findByGroupFinder(
	 ...
	 * @throws NoSuchCustomerException if a matching customer could not be found
	 */
	public static Customer findByGroupFinder_First(
			long groupId, OrderByComparator<Customer> orderByComparator)
		throws com.product.service.exception.NoSuchCustomerException {

		return getPersistence().findByGroupFinder_First(
	 ...
	 * @return the first matching customer, or <code>null</code> if a matching customer could not be found
	 */
	public static Customer fetchByGroupFinder_First(
		long groupId, OrderByComparator<Customer> orderByComparator) {

		return getPersistence().fetchByGroupFinder_First(
			groupId, orderByComparator);
	}
	 ...
	 * @throws NoSuchCustomerException if a matching customer could not be found
	 */
	public static Customer findByGroupFinder_Last(
			long groupId, OrderByComparator<Customer> orderByComparator)
		throws com.product.service.exception.NoSuchCustomerException {

		return getPersistence().findByGroupFinder_Last(
			groupId, orderByComparator);
	}
	 ...
	 * @return the last matching customer, or <code>null</code> if a matching customer could not be found
	 */
	public static Customer fetchByGroupFinder_Last(
		long groupId, OrderByComparator<Customer> orderByComparator) {

		return getPersistence().fetchByGroupFinder_Last(
			groupId, orderByComparator);
	}
	 ...
	 * @throws NoSuchCustomerException if a customer with the primary key could not be found
	 */
	public static Customer[] findByGroupFinder_PrevAndNext(
			long customerId, long groupId,
			OrderByComparator<Customer> orderByComparator)
		throws com.product.service.exception.NoSuchCustomerException {

		return getPersistence().findByGroupFinder_PrevAndNext(
	 ...
	 * @param groupId the group ID
	 */
	public static void removeByGroupFinder(long groupId) {
		getPersistence().removeByGroupFinder(groupId);
	}
	 ...
	 * @return the number of matching customers
	 */
	public static int countByGroupFinder(long groupId) {
		return getPersistence().countByGroupFinder(groupId);
	}
